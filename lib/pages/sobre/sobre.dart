...
class SobreState extends State<SobreWidget> {
  String _appName;
  String _packageName;
  String _version;
  String _buildNumber;
        ...
        body: Container(
          child: ListView(
            children: [
              ...
              ExpansionTile(
                title: Text(Strings.politicaPrivacidade),
                expandedAlignment: Alignment.topLeft,
                children: [politicaPrivacidade()],
              ),
              ExpansionTile(
                title: Text(Strings.termosCondicoes),
                expandedAlignment: Alignment.topLeft,
                children: [termos()],
              )
            ],
  ...
  Widget politicaPrivacidade() {
    return Html(
      data: """
        <h4>Privacy Policy</h4>
        <p>clbcabral built the Meu Patrimônio app as
        an Open Source app. This SERVICE is provided by
        clbcabral at no cost and is intended for use as
        is.</p>
        ...
        Meu Patrimônio unless otherwise defined in this Privacy Policy.</p>
        ...
        I will be able to do necessary actions.</p>
        ...
        this page.</p>
        <p>This policy is effective as of 2020-09-17</p>
        <h4>Contact Us</h4>
        <p>If you have any questions or suggestions about my
        Privacy Policy, do not hesitate to contact me at https://github.com/clbcabral/meupatrimonioapp.</p>
  ...
  Widget termos() {
    ...
    <p>By downloading or using the app, these terms will
                  ...
                  to it, still belong to clbcabral.
                </p><p>clbcabral is committed to ensuring that the app is
                  as useful and efficient as possible. For that reason, we
                  reserve the right to make changes to the app or to charge for
                  its services, at any time and for any reason. We will never
                  charge you for the app or its services without making it very
                  clear to you exactly what you’re paying for.
                </p><p>The Meu Patrimônio app stores and processes personal data that
                  ...
                  that the Meu Patrimônio app won’t work properly or at all.
                </p><p>The app does use third party services that declare their own
                    Terms and Conditions.
                  </p><p>Link to Terms and Conditions of third party service
                    providers used by the app
                  </p>
                <ul><li><a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer">Google Play Services</a></li></ul>
<p>You should be aware that there are certain things that
                  clbcabral will not take responsibility for. Certain
                  functions of the app will require the app to have an active
                  internet connection. The connection can be Wi-Fi, or provided
                  by your mobile network provider, but clbcabral
                  cannot take responsibility for the app not working at full
                  functionality if you don’t have access to Wi-Fi, and you don’t
                  have any of your data allowance left.
                </p><p>If you’re using the app outside of an area with Wi-Fi, you
                ...
                </p><p>Along the same lines, clbcabral cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service,
                  clbcabral cannot accept responsibility.
                </p><p>With respect to clbcabral’s responsibility for your
                  use of the app, when you’re using the app, it’s important to
                  bear in mind that although we endeavour to ensure that it is
                  updated and correct at all times, we do rely on third parties
                  to provide information to us so that we can make it available
                  to you. clbcabral accepts no liability for any
                  ...
                  using the app. clbcabral does not promise that it
                  ...
                  from your device.
                </p><h4>Changes to This Terms and Conditions</h4>
<p>I may update our Terms and Conditions
                  from time to time. Thus, you are advised to review this page
                  periodically for any changes. I will
                  notify you of any changes by posting the new Terms and
                  Conditions on this page.
                </p><p>These terms and conditions are effective as of 2020-09-17
                </p><h4>Contact Us</h4><p>If you have any questions or suggestions about my
                  Terms and Conditions, do not hesitate to contact me
                  at https://github.com/clbcabral/meupatrimonioapp.
                </p><p>This Terms and Conditions page was generated by
